...
INTEGER, PARAMETER :: DVODES_SOLVER=5            !< Flag for COMBUSTION_ODE_SOLVER: SUNDIALS DVODES
INTEGER, PARAMETER :: DASSL_SOLVER=6             !< Flag for COMBUSTION_ODE_SOLVER: DASSL
INTEGER, PARAMETER :: SDIRK4_SOLVER=7            !< Flag for COMBUSTION_ODE_SOLVER: SDIRK4
