...
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ADIABATIC_FLAME_TEMPERATURE,DVODE_MIN_ATOL,EXTINCTION_MODEL,FINITE_RATE_MIN_TEMP,&
...
INTEGER :: NS,NS2,NR,COUNT_NON_ZERO(N_TRACKED_SPECIES,N_SPECIES)
...
IF (TRIM(ODE_SOLVER)/='null') THEN
   SELECT CASE (TRIM(ODE_SOLVER))
      ...
      CASE ('DVODES')
         ...
         COUNT_NON_ZERO = 0
         DO NS=1,N_TRACKED_SPECIES
            COUNT_NON_ZERO(NS,NS)=1
         ENDDO
         DO NR=1,N_REACTIONS
            RN=>REACTION(NR)
            DO NS=1,RN%N_SMIX_FR
               DO NS2=1,RN%N_SPEC
                  COUNT_NON_ZERO(RN%NU_INDEX(NS),YP2ZZ(RN%N_S_INDEX(NS2))) = 1
               ENDDO
            ENDDO
         ENDDO
      CASE DEFAULT
