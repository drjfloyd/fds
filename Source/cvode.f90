...
!> \the right hand side function of the ode d[c]/dt = wdot (=f).
!> \the ODE solver call this function during integration.
...
!> \calculate derivative (fvec) for a given cvec(n_tracked_species+2)
!> \this function is created separately to allow using it with other ode solvers in future.
