...
INTEGRATION_LOOP: DO TIME_ITER = 1,MAX_CHEMISTRY_SUBSTEPS
   ...
   INTEGRATOR_SELECT: SELECT CASE (COMBUSTION_ODE_SOLVER)
      ...
      CASE (DVODES_SOLVER)
         ...
         ENDDO
         OPTIONS = SET_OPTS(DENSE_J=.TRUE.,ABSERR_VECTOR=ATOL,RELERR_VECTOR=RTOL,USER_SUPPLIED_JACOBIAN=.TRUE.,MXSTEP=10000)!,&
!                            CONSTRAINED=BOUNDED_COMPONENTS,CLOWER=LOWER_BOUND,CUPPER=UPPER_BOUND)
         ...
         DO
            ...
            IF (ISTATE == 2) EXIT
            WRITE(LU_ERR,*) 'ISTATE:',ISTATE,NM0,I0,J0,K0
            ...
            ELSE
               WRITE(LU_ERR,*) 'ISTATE2:',ISTATE,NM0,I0,J0,K0
               STOP
            ENDIF
         ENDDO
      ...
      CASE (DASSL_SOLVER)
         ...
         CALL DDASSL(DASSL_RESID,N_TRACKED_SPECIES,T1,ZZ_MIXED,A1,T2,INFO2,REL_ERR,ABS_ERR,ISTATE,RWORK,LRW,IWORK,LIW,RPAR,&
                     IPAR,DASSL_JAC)
         IF (INFO2(1) < 0) THEN
            WRITE(LU_ERR,*) 'DASSL LINE 556:',INFO2(1)
            STOP
         ENDIF
